...
import 'package:plant_app/app/widgets/background.dart';
import 'package:plant_app/app/widgets/rounded_button.dart';
import 'package:plant_app/app/widgets/rounded_input_field.dart';
import 'package:plant_app/app/widgets/rounded_password_field.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Lottie.asset(
                  'assets/json/plant_welcome.json',
                                  ...
                                  press: () async {
                                    ...
                                    if(username.isNotEmpty && password.isNotEmpty ) {
                                      ...
                                      var response = await http.post(
                                        Uri.parse('http://137.184.92.235/login/'),
                                        body: {
                                          "username": username,
                                          "password": password
                                        },
                                      ...
                                      if(password == password2) {
                                        if(password.length >= 6 && password2.length >= 6) {
                                          if(username.length >= 4) {
                                            ...
                                            var response = await http.post(
                                              Uri.parse('http://137.184.92.235/users/'),
                                              body: {
                                                'username': username,
                                                'password': password,
                                                'is_active': 'true'
