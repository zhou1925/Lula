...
class LastProductsViewSet(ModelViewSet):
    serializer_class = ProductSerializer
    queryset = Product.objects.all().order_by('-id')[:25]
    permission_classes = (permissions.AllowAny,)

class RandomProductsViewSet(ModelViewSet):
    serializer_class = ProductSerializer
    queryset = Product.objects.all().order_by('?')[:20]
    permission_classes = (permissions.AllowAny,)
